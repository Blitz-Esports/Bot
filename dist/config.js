...
const config = {
    ...
    features: {
        modmail: {
            ...
            defaultMessages: {
                branding: new discord_js_1.MessageEmbed().setAuthor({ name: "Blitz Esports | Support Team", iconURL: "https://iili.io/Ycyml4.gif" }).toJSON()
            },
            emojis: {
                success: "✅",
                error: "❌"
        ...
        clubOverview: {
            ...
            embeds: {
                clubInfo: new discord_js_1.MessageEmbed()
                    ...
                    .setColor("ORANGE")
                    .toJSON(),
                clubList: new discord_js_1.MessageEmbed()
                    .setThumbnail("https://iili.io/caCYXf.jpg")
                    .setColor("ORANGE")
                    .toJSON()
            }
...
framework_1.container.config = config;
